...
string_json = str(jsondata)
string_json = string_json.upper()
new_string = string_json.replace("<P>", " ")
new_string1 = new_string.replace("</P>", " ")
new_string2 = new_string1.replace("<B>", " ")
new_string3 = new_string2.replace("</B>", " ")
new_string4 = new_string3.replace("<I>", " ")
new_string5 = new_string4.replace("</I>", " ")
new_string6 = new_string5.replace("&", " ")
new_string7 = new_string6.replace("$", " ")
new_string8 = new_string7.replace("@", " ")
new_string9 = new_string8.replace("[", " ")
new_string10 = new_string9.replace("]", " ")
new_string11 = new_string10.replace(".", " ")
new_string12 = new_string11.replace(",", " ")
new_string13 = new_string12.replace("'", " ")
new_string14 = new_string13.replace("#", " ")
new_string15 = new_string14.replace("(", " ")
new_string16 = new_string15.replace(")", " ")
new_string17 = new_string16.replace("-", " ")
new_string18 = new_string17.replace('"', " ")
new_string19 = new_string18.replace("!", " ")
new_string20 = new_string19.replace("?", " ")
new_string21 = new_string20.replace("’", " ")
new_string22 = new_string21.replace("_", " ")
new_string23 = new_string22.replace(";", " ")
new_string24 = new_string23.replace(":", " ")
new_string25 = new_string24.replace("/", " ")
new_string26 = new_string25.replace("\\", "")
new_string26
...
new_string_list = new_string26.split()
qualified_words = {}
for i in new_string_list:
    if len(i) >= 3:
        qualified_words.append(i)
    print(qualified_words)
wordcount_dictionary = dict(enumerate(qualified_words))
...
optimal_Z = 10optimal_F + 12optimal_R + 16optimal_C
if optimal_F + optimal_R + optimal_C
...
def Collatz(start_number):
    ...
    while start_number != 1:
        collatz_numbers.append(start_number)
        if start_number == 1:
            collatz_numbers.append(start_number)
            break
    ...
    max_value = max(collatz_numbers)
    sum_collatz = sum(collatz_numbers)
    collatz_dict = {"collatz_sequence":collatz_numbers,"collatz_length":collatz_length, "max_collatz":max_value, "sequence_sum":sum_collatz}
    print(collatz_dict)
...
def Collatz_winner(number_list):
    ...
    '''
    largest_length = max(number_list)
    largest_

...
def relationship_status(from_member, to_member, social_graph):
    ...
    if from_member in social_graph:
        from_member_follows_to_member = to_member in social_graph[from_member]["following"]
    else:
        from_member_follows_to_member = False
    if to_member in social_graph:
        to_member_follows_from_member = from_member in social_graph[to_member]["following"]
    else:
        to_member_follows_from_member = False
